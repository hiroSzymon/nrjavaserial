...
public class NativeResource {
    ...
    private InputStream locateResource(String name) {
        ...
        } else if (OSUtil.isOpenBSD()) {
            if (OSUtil.isARM() && OSUtil.is64Bit()) {
                file = "/native/openbsd/ARM_64/" + name;
            } else if (OSUtil.is64Bit()) {
                file = "/native/openbsd/x86_64/" + name;
            } else {
                file = "/native/openbsd/x86_32/" + name;
            }
        } else {
    ...
    private static class OSUtil {
        ...
        public static boolean isOpenBSD() {
            return getOsName().toLowerCase().contains("openbsd");
        }
